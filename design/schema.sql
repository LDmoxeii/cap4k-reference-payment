...
create table reconciliation_item (
    ...
    payment_id varchar(36) comment '关联支付标识',
    payment_attempt_id varchar(36) comment '关联支付尝试标识',
    refund_id varchar(36) comment '关联退款标识',
...
create table merchant_settlement (
    ...
    predecessor_settlement_id varchar(36) comment '前序结算单标识',
    replacement_settlement_id varchar(36) comment '替代结算单标识',
