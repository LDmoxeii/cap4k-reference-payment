...
@DesignBlockMetadata(tag = "query", name = "GetPayment", packageName = "payment.read", description = "Read a persisted payment and all payment-attempt adjudication summaries", aggregates = ["Payment"], family = "query")
object GetPaymentQry {
    data class Request(val paymentId: String) : Query<Response>
    data class Response(
